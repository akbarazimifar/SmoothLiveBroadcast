...
public class Tools {
    ...
    public static void SlowShow(View aView, int aMils) {
        aView.setAlpha(0.0f);
        aView.setVisibility(View.VISIBLE);
        aView.animate().alpha(1.0f).setDuration(aMils);
    }
    ...
    public static String getDataTimeStamp1() {
        String result = DateFormat.format("yyyy-MM-dd hh:mm:ss", new Date()).toString();
        return result;
    }


    public static String getDataTimeStamp2() {
        String result = DateFormat.format("yyyy_MM_dd_hh_mm_ss", new Date()).toString();
        return result;
    }
